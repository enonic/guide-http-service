...
TIP: Additional information on HTTP services can be found in the offical XP documentation: https://developer.enonic.com/docs/xp/stable/runtime/engines/http-service
